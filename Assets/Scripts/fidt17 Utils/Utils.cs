...
public static class Utils {
    ...
    public static Node RandomNode() => NodeAt(new Vector2Int((int) Random.Range(0, MapSize), (int) Random.Range(0, MapSize)));
    public static Node NodeAt(Vector2Int position) => PathGrid.NodeAt(position.x, position.y);
    public static Node NodeAt(int x, int y) => PathGrid.NodeAt(x, y);
